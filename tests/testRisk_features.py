...
'fun', 'reading', 'goodbye', 'luck', 'tas']

features = risk_feature.extract(tokens)

print(f'Diccionario  del conteo de clasificación de emociones: {features}')


"""
Observaciones:
En este punto debemos de analizar las palabras asociadas a emociones
y hacer un dataset para poder colocarlas en este punto
"""